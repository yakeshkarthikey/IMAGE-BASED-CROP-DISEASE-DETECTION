...
import os
print(os.listdir('D:/Py/Bala_proj/corn or maize leaf disease dataset'))
...
# %%
epochs = 5
path = 'D:/Py/Bala_proj/corn or maize leaf disease dataset/'
...
# %%
vgg16_model.save("D:/Py/Bala_proj/corn or maize leaf disease dataset/vgg16.h5")
